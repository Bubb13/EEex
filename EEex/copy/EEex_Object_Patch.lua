...
(function()
	...
	EEex_HookConditionalJumpOnFail(EEex_Label("Hook-CAIObjectType::Decode()-TargetNameOverride"), 0, EEex_FlattenTable({
		{[[
	...
	EEex_HookConditionalJumpOnSuccess(EEex_Label("Hook-CAIObjectType::Decode()-DefaultJmp"), 0, EEex_FlattenTable({
		{[[
