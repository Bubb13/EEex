...
if not EEex_MinimalStartup then
	for _, labelEntry in ipairs({
		...
		{"CAIGroup::GetGroupLeader", 0x4FE390},
		...
		{"CGameArea::OnActionButtonClickGround", 0x556F60},
		...
		{"CInfGame::OnPortraitLDblClick", 0x631500},
		{"CInfGame::SelectCharacter", 0x6377E0},
		{"CInfGame::SelectToolbar", 0x6379D0},
		{"CInfGame::UnselectAll", 0x63F5F0},
