...
EEex_DecodeProjectileSources = {
	...
	[EEex_Label("CGameAIBase::FireSpell()_DecodeProjectile")             + 0x5] = EEex_ProjectileHookSource.FORCE_SPELL_OPCODE,
	[EEex_Label("CGameAIBase::FireSpellPoint()_DecodeProjectile")        + 0x5] = EEex_ProjectileHookSource.FORCE_SPELL_POINT_OPCODE,
	[EEex_Label("CProjectileMulti::CProjectileMulti()_DecodeProjectile") + 0x5] = EEex_ProjectileHookSource.MAGIC_MISSILE_PROJECTILE,
	[EEex_Label("CProjectileArea::CreateSecondary()_DecodeProjectile")   + 0x5] = EEex_ProjectileHookSource.EXPLOSION_PROJECTILE,
	[EEex_Label("CProjectileArea::Explode()_DecodeProjectile")           + 0x5] = EEex_ProjectileHookSource.SECONDARY_PROJECTILE,
	[EEex_Label("CProjectileArea::RayAreaEffect()_DecodeProjectile")     + 0x5] = EEex_ProjectileHookSource.SPIRITUAL_WRATH_RAY,
	[EEex_Label("CGameSprite::Swing()_DecodeProjectile")                 + 0x5] = EEex_ProjectileHookSource.RANGED_ATTACK_START,
	[EEex_Label("CGameSprite::Swing()_DecodeProjectile_2")               + 0x5] = EEex_ProjectileHookSource.RANGED_ATTACK,
	[EEex_Label("CGameSprite::UseItem()_DecodeProjectile")               + 0x5] = EEex_ProjectileHookSource.USE_ITEM,
	[EEex_Label("CGameSprite::UseItemPoint()_DecodeProjectile")          + 0x5] = EEex_ProjectileHookSource.USE_ITEM_POINT,
}
