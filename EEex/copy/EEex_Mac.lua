...
for _, macroEntry in ipairs({
	...
	{"fild_[esp]", "DB 04 24"},
	{"fld_dword:[esp]", "D9 04 24"},
	{"fld_qword:[eax]", "DD 00"},
	{"fstp_dword:[esp]", "D9 1C 24"},
	...
	{"jnz_dword", "0F 85"},
	{"jz_dword", "0F 84"},
	{"lea_eax_[eax+eax*2]", "8D 04 40"},
	{"lea_eax_[ebp+byte]", "8D 45"},
	{"lea_eax_[ebp+dword]", "8D 85"},
	{"lea_eax_[ebp]", "8D 45 00"},
	{"lea_eax_[ebx+byte]", "8D 43"},
	{"lea_eax_[ebx+dword]", "8D 83"},
	{"lea_eax_[ecx+byte]", "8D 41"},
	...
	{"mov_esp_ebp", "8B E5"},
	{"mov_word:[edx+byte]_ax", "66 89 42"},
	{"mov_word:[edx+byte]_cx", "66 89 4A"},
	{"mov_word:[edx]_ax", "66 89 02"},
	{"movsx_eax_al", "0F BE C0"},
	{"movsx_eax_word:[ebp+esi*2+dword]", "0F BF 84 75"},
	{"movsx_eax_word:[esi*2+dword]", "0F BF 04 75"},
	{"movsx_ebx_ax", "0F BF D8"},
	{"movzx_eax_byte:[eax+byte]", "0F B6 40"},
	{"movzx_eax_byte:[eax+dword]", "0F B6 80"},
	{"movzx_eax_word:[eax]", "0F B7 00"},
	{"movzx_eax_word:[edx+byte]", "0F B7 42"},
	{"movzx_eax_word:[esi+byte]", "0F B7 46"},
	{"movzx_ecx_si", "0F B7 CE"},
